...
export default class PetProfile extends React.Component {
  ...
  showInterestComp() {
    if (this.state.interest === false) {
      ...
      return (
        <div> {this.state.owner.firstName} has received your interest! </div>
      );
    }
  }
            ...
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="card border-dark bg-warning mb-3 ml-5">
                  <div className="card-header bg-dark text-white centerElement">
                    Contact
                  </div>
                  <div className="card-body">
                    <h5 className="card-title">
                      {this.state.pet.name}'s owner:{" "}
                    </h5>
                    <p className="card-text">
                      Name: {this.state.owner.firstName}{" "}
                      {this.state.owner.lastName} <br />
                      email: {this.state.owner.email} <br />
                      zipcode: {this.state.owner.zipcode} <br />
                      <br />
